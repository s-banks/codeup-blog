...
public class HelloController {
	...
	public String reportNumber(@PathVariable int num) {
		...
		String numSquared = String.format("The number %d squared is %b.", num, (int) Math.pow(num, 2));
		String fizzBuzzEval = String.format("The number %d when run through FizzBuzz would print %s", num, fizzBuzzEvaluation(num));
		return String.format("<h3>%s</h3><ul><li>%n%s</li><br><li>%n%s</li><br><li>%n%s</li>", intro, isEven, numSquared, fizzBuzzEval);
	}
}
